...
/**
 *  \file       htdocs/modulebuilder/template/pettycash_agenda.php
 *  \ingroup    pettycash
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->pettycash->multidir_output[!empty($object->entity) ? $object->entity : $conf->entity]."/".$object->id;
}
...
if ($object->id > 0) {
	...
	llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-pettycash page-card_agenda');
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_pettycash_'.$object->id;
