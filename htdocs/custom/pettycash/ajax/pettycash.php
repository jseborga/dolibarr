...
/**
 *       \file       htdocs/pettycash/ajax/pettycash.php
 *       \brief      File to return Ajax response on pettycash list request
 */
...
// Security check
if (!$user->hasRight('pettycash', 'pettycash', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax pettycash/ajax/pettycash.php");
