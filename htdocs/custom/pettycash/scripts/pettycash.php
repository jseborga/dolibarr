...
/**
 *      \file       htdocs/modulebuilder/template/scripts/pettycash.php
 *		\ingroup    pettycash
 *      \brief      This file is a command line script for module MyModule. You can execute it with:
 *      			php pettycash/scripts/pettycash.php
 */
...
//$pettycash=new MyObject($db);

// Example for inserting creating object in database
/*
dol_syslog($script_file." CREATE", LOG_DEBUG);
$pettycash->prop1='value_prop1';
$pettycash->prop2='value_prop2';
$id=$pettycash->create($user);
if ($id < 0) { $error++; dol_print_error($db,$pettycash->error); }
...
$result=$pettycash->fetch($id);
if ($result < 0) { $error; dol_print_error($db,$pettycash->error); }
else print "Object with id=".$id." loaded\n";
*/

// Example for updating object in database ($pettycash must have been loaded by a fetch before)
/*
dol_syslog($script_file." UPDATE", LOG_DEBUG);
$pettycash->prop1='newvalue_prop1';
$pettycash->prop2='newvalue_prop2';
$result=$pettycash->update($user);
if ($result < 0) { $error++; dol_print_error($db,$pettycash->error); }
else print "Object with id ".$pettycash->id." updated\n";
*/

// Example for deleting object in database ($pettycash must have been loaded by a fetch before)
/*
dol_syslog($script_file." DELETE", LOG_DEBUG);
$result=$pettycash->delete($user);
if ($result < 0) { $error++; dol_print_error($db,$pettycash->error); }
else print "Object with id ".$pettycash->id." deleted\n";
*/
