...
/**
 * \file    htdocs/modulebuilder/template/class/actions_pettycash.class.php
 * \ingroup pettycash
...
class ActionsMyModule extends CommonHookActions
{
	...
	public function loadDataForCustomReports($parameters, &$action, $hookmanager)
	{
		...
		if ($parameters['tabfamily'] == 'pettycash') {
			...
			$this->results['picto'] = 'pettycash@pettycash';
		}
		...
		$arrayoftypes = array();
		//$arrayoftypes['pc_pettycash'] = array('label' => 'MyObject', 'picto'=>'pettycash@pettycash', 'ObjectClassName' => 'MyObject', 'enabled' => isModEnabled('pettycash'), 'ClassPath' => "/pettycash/class/pettycash.class.php", 'langs'=>'pettycash@pettycash')
	...
	public function restrictedArea($parameters, &$action, $hookmanager)
	{
		...
		if ($parameters['features'] == 'pettycash') {
	...
	public function completeTabsHead(&$parameters, &$object, &$action, $hookmanager)
	{
		...
		if ($parameters['mode'] == 'remove') {
			...
			if (in_array($element, ['context1', 'context2'])) {
				...
				$parameters['head'][$counter][0] = dol_buildpath('/pettycash/pettycash_tab.php', 1) . '?id=' . $id . '&amp;module='.$element;
				$parameters['head'][$counter][1] = $langs->trans('MyModuleTab');
				if ($datacount > 0) {
					$parameters['head'][$counter][1] .= '<span class="badge marginleftonlyshort">' . $datacount . '</span>';
				}
				$parameters['head'][$counter][2] = 'pettycashemails';
				$counter++;
			}
