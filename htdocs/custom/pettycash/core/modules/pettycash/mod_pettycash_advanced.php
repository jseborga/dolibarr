...
/**
 * \file       htdocs/core/modules/pettycash/mod_pettycash_advanced.php
 * \ingroup    pettycash
 ...
 */
class mod_pettycash_advanced extends ModeleNumRefMyObject
{
	/**
	...
	public function getNextValue($object)
	{
		...
		$numFinal = get_next_value($db, $mask, 'pc_pettycash', 'ref', '', '', $date);
