...
/**
 * \file    htdocs/modulebuilder/template/core/boxes/pettycashwidget1.php
 * \ingroup pettycash
 ...
 */
class pettycashwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "pettycashbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "pettycash@pettycash";
	 ...
	 */
	public $lang = 'pettycash@pettycash';

	/**
	 * @var string[] Module dependencies
	 */
	public $depends = array('pettycash');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// $this->hidden = !$user->hasRight('pettycash', 'pettycash', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		$this->info_box_head = array(
			...
			'subpicto' => 'object_pettycash@pettycash',
